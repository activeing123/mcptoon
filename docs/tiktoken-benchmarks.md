...
SLIM format saves 91% tokens, tiktoken-verified. CLI approach works with every agent. The 5 pain points are real. A 128KB wheel, zero dependencies — 11,749 lines of stdlib Python across 21 modules.
