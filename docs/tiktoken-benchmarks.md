...
SLIM format saves 91% tokens, tiktoken-verified. CLI approach works with every agent. The 5 pain points are real. 50KB zero dependencies, read/audit in 10 minutes.
