...
SLIM format saves 91% tokens, tiktoken-verified. CLI approach works with every agent. The 5 pain points are real. A 156KB wheel, zero dependencies — 13,415 lines of stdlib Python across 23 modules.
