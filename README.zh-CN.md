...
[![Tests](https://img.shields.io/badge/Tests-1302%20passed-brightgreen)](#贡献)
...
18,086 行 Python、**206KB** wheel、**零第三方依赖**——只用标准库，由 CI 的
...
零依赖是硬规则，我们的测试门槛是每次改动先跑绿全套 1302 个测试。见
[CONTRIBUTING.md](CONTRIBUTING.md)、[DEVELOPERS.md](DEVELOPERS.md)。

项目本体：18,086 行 Python、27 个模块，零第三方依赖——供应链里 0 个要审计的环节。
