...
TRANSCRIPT: list[tuple[str, str]] = [
    ...
    ("txt", "║  255 tools listed in 581 tokens, not 71,929  ║"),
    ("txt", "╚══════════════════════════════════════════════╝"),
    ("txt", ""),
    ...
    ("ok", "  Compact             581      99.2%"),
    ("txt", ""),
    ("ok", "  Schemas are fetched, not injected \u2014 you pay for a listing, not for every turn"),
    ("ok", "  255 tools listed once: 581 tokens (71,929 \u2192 581, \u221299.2%, measured)"),
    ("txt", ""),
