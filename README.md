...
[![Tests](https://img.shields.io/badge/Tests-979%20passed-brightgreen)](#contributing)
...
python -m pytest tests/ -v   # 978 passed, 1 skipped
```
...
The codebase: 14,285 lines of Python across 24 modules, zero third-party dependencies.
