...
[![Tests](https://img.shields.io/badge/Tests-1384%20passed-brightgreen)](#contributing)
...
python -m pytest tests/ -v   # 1384 passed, 1 skipped
```
...
The codebase: **19,119 lines of Python across 28 modules**, zero third-party dependencies.
