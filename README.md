...
[![Tests](https://img.shields.io/badge/Tests-931%20passed-brightgreen)](#contributing)
...
python -m pytest tests/ -v   # 931 passed, 1 skipped
```

Zero dependencies is a hard rule — our test suite gates every change (931 tests
