...
[![Tests](https://img.shields.io/badge/Tests-1422%20passed-brightgreen)](#contributing)
...
python -m pytest tests/ -v   # 1422 passed, 1 skipped
```
...
The codebase: **19,520 lines of Python across 28 modules**, zero third-party dependencies.
