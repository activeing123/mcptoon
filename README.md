...
[![Tests](https://img.shields.io/badge/Tests-1269%20passed-brightgreen)](#contributing)
...
python -m pytest tests/ -v   # 1269 passed, 1 skipped
```

Zero dependencies is a hard rule — our test suite gates every change (1269 tests
