...
[![Tests](https://img.shields.io/badge/Tests-1221%20passed-brightgreen)](#contributing)
...
**Runtime.** Python ≥ 3.10 (CI: 3.10–3.13 × Linux, Windows, macOS). 26 modules,
17,058 lines of Python, a **206KB** wheel, **zero third-party dependencies** — standard
...
python -m pytest tests/ -v   # 1221 passed, 1 skipped
```

Zero dependencies is a hard rule — our test suite gates every change (1221 tests
...
The codebase: 17,058 lines of Python across 26 modules, zero third-party dependencies.
