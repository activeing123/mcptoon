...
[![Tests](https://img.shields.io/badge/Tests-1005%20passed-brightgreen)](#contributing)
...
python -m pytest tests/ -v   # 1005 passed, 1 skipped
```
...
The codebase: 14,944 lines of Python across 24 modules, zero third-party dependencies.
