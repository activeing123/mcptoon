...
[![Tests](https://img.shields.io/badge/Tests-798%20passed-brightgreen)](#contributing)
...
python -m pytest tests/ -v   # 798 passed, 1 skipped
```

Zero dependencies is a hard rule — our test suite gates every change (798 tests
